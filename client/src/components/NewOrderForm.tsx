  ...
  return (
    <NewOrderFormHeaderContainer>
      ...
      <NewOrderFormBodyContainer>
        ...
        />
         <SingleLineInput
          label="Please enter the INR amount you are willing to pay for each USDC."
          value={inrAmount === 0 ? '' : inrAmount.toString()}
          placeholder={'0'}
          onChange={(e) => {
            setInrAmount(e.currentTarget.value);
          }}
        />
         <SingleLineInput
          label="Total INR Amount"
          value={inrAmount * newOrderAmount === 0 ? '' : (inrAmount * newOrderAmount).toString()}
          placeholder={'0'}
          onChange={(e) => {
            setTotalInrAmount(e.currentTarget.value);
          }}
        />
        <Button
