...
import { formatAmountsForINR, formatAmountsForUSDC, getOrderStatusString } from '../helpers/tableFormatters';


enum FormState {
  DEFAULT = "DEFAULT",  // formatAmountsForINR(order.amountToPayINR),
  NEW = "NEW",
  CLAIM = "CLAIM",
  UPDATE = "UPDATE",
}
...
export const MainPage: React.FC<{}> = (props) => {
  ...
  */
  ...
  const orderTableData = fetchedOrders.map((order) => [
    ...
    formatAmountsForINR(order.amountToPayINR),
      ...
      <div className="title">
        ...
        <NumberedInputContainer>
          ...
          <NumberedStep step={1}>
            ...
            submitted by an off-ramper, and then send the requested fiat amount on PhonePe. After receiving a confirmation email
            from PhonePe, you will generate and then submit the proof to receive the USDC.
          </NumberedStep>
          <NumberedStep step={2}>
